...
- (instancetype)initWithDictionary:(NSDictionary *)aDictionary {
    ...
    if (self) {
        ...
        if([self.state isEqualToString:@"Solid"])
            self.stateColor = [UIColor grayColor];
        else if([self.state isEqualToString:@"Gas"])
            self.stateColor = [UIColor blueColor];
        else if([self.state isEqualToString:@"Liquid"])
            self.stateColor = [UIColor purpleColor];
        else
